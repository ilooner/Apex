...
public class LogicalPlanConfigurationTest {
                                                  ...
                                                  boolean portSet)
  {
    ...
    simpleAttributeOperatorHelperAssert(new SimpleTestApplicationWithName(),
                                        attributeObjOperator,
                                        props,
                                        val,
                                        operatorSet);
  ...
  @Test
  public void testDagLevelAttributeAccessibleToOperator()
  {
    AssignPropertyInCodeApp assignPropertyInCodeApp = new AssignPropertyInCodeApp();

    simpleAttributeOperatorHelperAssert(assignPropertyInCodeApp,
                                        OperatorContext.MEMORY_MB,
                                        null,
                                        (Integer) 4096,
                                        true);
  }
  ...
  private void simpleAttributeOperatorHelperAssert(StreamingApplication app,
  ...
  public static class AssignPropertyInCodeApp implements StreamingApplication
  {
    public final GenericTestOperator gt1 = new GenericTestOperator();
    public final GenericTestOperator gt2 = new GenericTestOperator();
    public final GenericTestOperator gt3 = new GenericTestOperator();
    ...
    public void populateDAG(DAG dag, Configuration conf)
    {
      dag.setAttribute(OperatorContext.MEMORY_MB, 4096);
      dag.addOperator("operator1", gt1);
      dag.addOperator("operator2", gt2);
      dag.addOperator("operator3", gt3);
      dag.addStream("s1", gt1.outport1, gt2.inport1);
